...
class MainActivity : AppCompatActivity() {
    ...
    private fun generateTips(): List<Tip> {
        return listOf(
            Tip("Stay Hydrated",
                "Drink at least 8 glasses of water today. Proper hydration is essential for overall health, improving digestion, skin health, and cognitive function.",
                R.drawable.day_1),
            Tip("Morning Yoga",
                "Start your day with a 20-minute yoga session. Yoga can improve flexibility, reduce stress, and increase mindfulness to set a positive tone for your day.",
                R.drawable.day_2),
            Tip("Healthy Breakfast",
                "Start your day with a nutritious breakfast. A balanced breakfast provides energy, improves focus, and helps maintain a healthy weight.",
                R.drawable.day_3),
